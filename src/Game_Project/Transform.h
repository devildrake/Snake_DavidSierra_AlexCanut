...
struct Transform {
	...
	Transform(int x_, int y_) : x(x_), y(y_), w(0), h(0) {}; //constructor, inicializacion de lasvariables a los parametros pasados
	Transform(int x_, int y_, int w_, int h_) : x(x_), y(y_), w(w_), h(h_) {}; //constructor 2,inicializacion de lasvariables a los parametros pasados
